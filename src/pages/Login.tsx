...
import "/public/css/pages/LoginRegister.css"; // Importación correcta del archivo CSS
...
export const Login = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url('/public/css/stockin.gif')`, // Asegúrate de que esta ruta sea correcta
